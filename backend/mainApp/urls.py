...
urlpatterns = [
    ...
    path('event/<int:event_id>/', views.EventAPI.as_view(), name='event_id'),
    path('groupEvent/<int:group_id>/', views.GroupEventAPI.as_view(), name='group_event_id'),
    path('news/<int:pk>/', views.NewsAPI.as_view(), name='news-detail'),
    path('sources/', views.SourceAPI.as_view(), name='sources'),
    path('groupsources/<int:group_id>', views.GroupSourceAPI.as_view(), name='sources_group_id'),
    ...
    path('forum/<int:group_id>', views.ForumGroupAPI.as_view(), name='forum_group_id'),
